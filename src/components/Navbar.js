    ...
    <nav className="container-fluid navbar navbar-expand-md navbar-light bg-white fixed-top">
      <div className="container-fluid d-flex align-items-center mx-0 px-0">
        <div className="navbar-brand fw-bold fs-3 ms-0 ps-0">
          <span className="fw-bold" style={{ color: '#0290ff' }}>
            Bookstore CMS
          </span>
        </div>
        <button
        ...
        <div
          className="collapse navbar-collapse text-end justify-content-between text-center"
              ...
              <li key={link.id} className="link">
                <NavLink
                  ...
                  className={({ isActive }) => (isActive
                    ? 'active nav-item text-decoration-none'
                    : 'nav-item text-decoration-none')}
                >
                  <p className="nav-link pt-4">{link.text}</p>
                </NavLink>
              </li>
            ))}
          </ul>
